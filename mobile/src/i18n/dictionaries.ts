...
export const tr = {
  ...
  "comments.placeholder": "Bu tadım hakkında ne düşünüyorsunuz?",
  "comments.label": "Yorumunuz",
  "comments.send": "Gönder",
  "comments.sendFailed": "Yorum gönderilemedi",
  "comments.delete": "Yorumu sil",
  "comments.deleteConfirm": "Silmek için tekrar dokunun",
  "comments.deleteFailed": "Yorum silinemedi",
  "comments.remaining": "{count} karakter kaldı",
  "comments.openPublic": "Yorumlar ({count})",
...
export const en: Record<TranslationKey, string> = {
  ...
  "comments.placeholder": "What did you make of this tasting?",
  "comments.label": "Your comment",
  "comments.send": "Post",
  "comments.sendFailed": "Could not post the comment",
  "comments.delete": "Delete comment",
  "comments.deleteConfirm": "Tap again to delete",
  "comments.deleteFailed": "Could not delete the comment",
  "comments.remaining": "{count} characters left",
  "comments.openPublic": "Comments ({count})",
