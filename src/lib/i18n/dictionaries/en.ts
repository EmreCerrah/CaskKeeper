...
export const en: Record<TranslationKey, string> = {
  ...
  "validation.nameMax": "Name can be at most 60 characters",
  "validation.email": "Enter a valid email address",
  "validation.passwordMin": "Password must be at least 8 characters",
  "validation.passwordMax": "Password can be at most 72 characters",
  "validation.passwordRequired": "Password is required",
  "validation.passwordMismatch": "Passwords do not match",
  "validation.bioMax": "The bio can be at most 500 characters",
  "validation.url": "Enter a valid URL",
  "validation.brandMin": "The brand must be at least 2 characters",
  "validation.whiskeyNameMin": "The product name must be at least 2 characters",
  "validation.distilleryRequired": "A distillery is required",
  "validation.typeRequired": "A type is required",
  "validation.regionRequired": "A region is required",
  "validation.countryRequired": "A country is required",
  "validation.abvRange": "Must be between 0 and 100",
  "validation.whiskeyIdInvalid": "Invalid whisky identifier",
  "validation.tastingDateRequired": "A tasting date is required",
  "validation.ratingNumber": "The score must be a number",
  "validation.ratingRange": "The score must be between 0 and 100",
  "validation.noseNotesMax": "Nose notes can be at most 1000 characters",
  "validation.palateNotesMax": "Palate notes can be at most 1000 characters",
  "validation.finishNotesMax": "Finish notes can be at most 1000 characters",
  "validation.finishLengthRequired": "Choose a finish length",
  "validation.personalNotesMax": "Personal notes can be at most 2000 characters",
  "validation.commentRequired": "A comment cannot be empty",
  "validation.commentMax": "A comment can be at most 1000 characters",
  ...
  "errors.loginRequired": "Sign in to perform this action",
  "errors.adminRequired": "This action requires administrator rights",
  "errors.tooManyAttempts": "Too many attempts. Please try again shortly.",

  "errors.invalidRegistration": "Invalid registration details",
  "errors.invalidLoginData": "Invalid sign-in details",
  "errors.emailTaken": "An account with this email address already exists",
  ...
  "errors.tastingNoteNotFound": "Tasting note not found",
  "errors.tastingNoteForbidden": "You do not have access to this tasting note",
  "errors.invalidTastingNote": "Invalid tasting note",
  "errors.whiskeyNotInCatalogue": "That whisky is not in the catalogue",

  "errors.invalidComment": "Invalid comment",
  "errors.commentNotFound": "Comment not found",
  "errors.commentDeleteForbidden": "You do not have permission to delete this comment",
  "errors.notificationNotFound": "Notification not found",

  "errors.whiskeyNotFound": "Whisky not found",
  "errors.whiskeyNotFoundSlug": "Whisky not found: {slug}",
  "errors.whiskeyAlreadyExists": "This whisky is already in the catalogue (slug: {slug})",
  "errors.whiskeyConflict": "Another whisky with these details already exists (slug: {slug})",
  "errors.invalidWhiskeyData": "Invalid whisky data",
};
